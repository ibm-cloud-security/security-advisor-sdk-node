...
describe('FindingsApiV1 service setup', () => {
    ...
    test('should use constructor to setup service with default url', () => {
        ...
        expect(client.baseOptions.serviceUrl).toBe('https://us-south.secadvisor.cloud.ibm.com/findings')
    })
...
describe('FindingsApiV1 postGraph', () => {
    ...
    test('should postGraph query successfully', async (done) => {
        ...
        try {
            let resp = await client.postGraph({
                accountId: accountId,
...
describe('FindingsApiV1 listProviders', () => {
    ...
    test('should listProviders query successfully', async (done) => {
        ...
        try {
            let resp = await client.listProviders({
                accountId: accountId,
            })
            expect(resp.status).toBe(200)
...
describe('FindingsApiV1 createNote', () => {
    ...
    test('should createNote query successfully', async (done) => {
        ...
        try {
            let ts = Date.now()
            let resp = await client.createNote({
                accountId: accountId,
            ...
            let deleteResp = await client.deleteNote({
                accountId: accountId,
                providerId: "provider_"+ts,
    ...
    test('should fail to createNote query with missing params', async (done) => {
        ...
        try {
            ...
            expect(err.toString()).toEqual("Error: Missing required parameters: providerId, shortDescription, longDescription, kind, id, reportedBy")
            done()
        }
    })
})
...
describe('FindingsApiV1 listNotes', () => {
    ...
    test('should listNotes query successfully', async (done) => {
        ...
        try {
            let ts = Date.now()
            let createResp = await client.createNote({
                accountId: accountId,
                providerId: "provider_"+ts,
                shortDescription: "test",
                longDescription: "long test",
            ...
            let resp = await client.listNotes({
                accountId: accountId,
                providerId: "provider_"+ts
            })
            expect(resp.status).toBe(200)
...
describe('FindingsApiV1 getOccurrenceNote', () => {
    ...
    test('should fail to getOccurrenceNote query with missing params', async (done) => {
        ...
        try {
            ...
            expect(err.toString()).toEqual("Error: Missing required parameters: accountId, providerId, occurrenceId")
            done()
        }
    })
})
...
describe('FindingsApiV1 getNote', () => {
    ...
    test('should fail to getNote query with missing params', async (done) => {
        ...
        try {
            ...
            expect(err.toString()).toEqual("Error: Missing required parameters: accountId, providerId, noteId")
            done()
        }
    })
})
...
describe('FindingsApiV1 updateNote', () => {
    ...
    test('should updateNote query successfully', async (done) => {
        ...
        try {
            ...
            let resp = await client.updateNote({
                accountId: accountId,
                providerId: "provider_"+ts,
                noteId: "create_note_"+ts,
    ...
    test('should fail to updateNote query with missing params', async (done) => {
        ...
        try {
            ...
            expect(err.toString()).toEqual("Error: Missing required parameters: accountId, providerId, noteId, shortDescription, longDescription, kind, id, reportedBy")
            done()
        }
    })
})
...
describe('FindingsApiV1 Occurrence tests', () => {
    ...
    describe('FindingsApiV1 createOccurrence', () => {
        test('should create FIDNING Occurrence successfully', async (done) => {
            jest.setTimeout(30000)
            try {
                let resp = await client.createOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    name: 'occurence1',
                    resourceUrl: 'string',
                ...
                let deleteResp = await client.deleteOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
        ...
        test('should fail to createOccurrence query with missing params', async (done) => {
            ...
            try {
                ...
                expect(err.toString()).toEqual("Error: Missing required parameters: accountId, providerId, noteName, kind, id")
                done()
            }
        })
    })
    ...
    describe('FindingsApiV1 listNoteOccurrences', () => {
        test('should create FIDNING Occurrence successfully', async (done) => {
            jest.setTimeout(30000)
            try {
                let createResp = await client.createOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    name: 'occurence1',
                    resourceUrl: 'string',
                ...
                let resp = await client.listNoteOccurrences({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    noteId: "create_note_" + ts
                })
    ...
    describe('FindingsApiV1 getOccurrence', () => {
        test('should FIDNING getOccurrence successfully', async (done) => {
            ...
            try {
                ...
                let resp = await client.getOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    occurrenceId: "create_occ_" + ts,
                })
    ...
    describe('FindingsApiV1 listOccurrences', () => {
        test('should listOccurrences successfully', async (done) => {
            ...
            try {
                ...
                let resp = await client.listOccurrences({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                })
                expect(resp.status).toBe(200)
    ...
    describe('FindingsApiV1 updateOccurrence', () => {
        test('should updateOccurrence successfully', async (done) => {
            ...
            try {
                ...
                let resp = await client.updateOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    occurrenceId: "create_occ_" + ts,
                    name: 'occurence1',
        ...
        test('should fail to updateOccurrence query with missing params', async (done) => {
            ...
            try {
                ...
                expect(err.toString()).toEqual("Error: Missing required parameters: accountId, providerId, occurrenceId, noteName, kind, id")
                done()
            }
        })
    })
    ...
    describe('FindingsApiV1 deleteOccurrence', () => {
        test('should deleteOccurrence successfully', async (done) => {
            ...
            try {
                ...
                let resp = await client.deleteOccurrence({
                    accountId: accountId,
                    providerId: "provider_" + ts,
                    occurrenceId: "create_occ_" + ts
                });
