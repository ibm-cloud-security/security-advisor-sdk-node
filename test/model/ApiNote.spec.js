...
(function(root, factory) {
  ...
  describe('ApiNote', function() {
    it('should create an instance of ApiNote', function() {
      // uncomment below and update the code to test ApiNote
      //var instance = new findings.ApiNote();
      //expect(instance).to.be.a(findings.ApiNote);
    });
