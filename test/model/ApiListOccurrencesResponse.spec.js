...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new findings.ApiListOccurrencesResponse();
  });
  ...
  describe('ApiListOccurrencesResponse', function() {
    it('should create an instance of ApiListOccurrencesResponse', function() {
      // uncomment below and update the code to test ApiListOccurrencesResponse
      //var instance = new findings.ApiListOccurrencesResponse();
      //expect(instance).to.be.a(findings.ApiListOccurrencesResponse);
    });
