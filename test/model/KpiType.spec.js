...
(function(root, factory) {
  ...
  describe('KpiType', function() {
    it('should create an instance of KpiType', function() {
      // uncomment below and update the code to test KpiType
      //var instance = new findings.KpiType();
      //expect(instance).to.be.a(findings.KpiType);
    });
