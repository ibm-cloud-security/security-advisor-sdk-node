...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new findings.DataTransferred();
  });
  ...
  describe('DataTransferred', function() {
    it('should create an instance of DataTransferred', function() {
      // uncomment below and update the code to test DataTransferred
      //var instance = new findings.DataTransferred();
      //expect(instance).to.be.a(findings.DataTransferred);
    });
