...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new findings.InlineResponse2001FindingDataTransferred();
  });
  ...
  describe('InlineResponse2001FindingDataTransferred', function() {
    it('should create an instance of InlineResponse2001FindingDataTransferred', function() {
      // uncomment below and update the code to test InlineResponse2001FindingDataTransferred
      //var instance = new findings.InlineResponse2001FindingDataTransferred();
      //expect(instance).to.be.a(findings.InlineResponse2001FindingDataTransferred);
    });
