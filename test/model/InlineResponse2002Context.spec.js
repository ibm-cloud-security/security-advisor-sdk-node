...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new findings.InlineResponse2002Context();
  });
  ...
  describe('InlineResponse2002Context', function() {
    it('should create an instance of InlineResponse2002Context', function() {
      // uncomment below and update the code to test InlineResponse2002Context
      //var instance = new findings.InlineResponse2002Context();
      //expect(instance).to.be.a(findings.InlineResponse2002Context);
    });
